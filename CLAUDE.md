...
Cogito.Azure.Storage — Additional components for managing Azure Storage.

Publishes 4 packages: `Cogito.Azure.Storage`, `Cogito.Azure.Storage.Autofac`, `Cogito.Azure.Storage.Tables`, `Cogito.Azure.Storage.Tables.Autofac`.
